    ...
    <section id="features_1">
        <div id="learn_more" class="container">
            ...
            <div class="row row-centered">
                <div class="col-sx-1 col-md-3 col-lg-3 col-centered-top margin-top" ><img class="img-responsive" src="images/carlo.png" alt="img"> <h3>Branca Carlo </h3> <span class="ruolo">Frontend / Backend Developer</span></div>
							  <div class="col-sx-1 col-md-3 col-lg-3 col-centered-top margin-top col-md-offset-1" ><img class="img-responsive" src="images/fabio.png"   alt="img"> <h3>Cuccaro Fabio </h3> <span class="ruolo">Frontend Developer</span></div>
								<div class="col-sx-1 col-md-3 col-lg-3 col-centered-top margin-top col-md-offset-1"><img class="img-responsive" src="images/luigi.png"   alt="img"> <h3>Vecchione Luigi </h3> <span class="ruolo">Frontend Developer</span></div>
                <div class="col-sx-1 col-md-3 col-lg-3 col-centered-top margin-top"><img class="img-responsive" src="images/cosmo.png"  alt="img"> <h3>D'Uva Cosmo </h3>  <span class="ruolo">Web Developer / Designer </span></div>
							  <div class="col-sx-1 col-md-3 col-lg-3 col-centered-top margin-top col-md-offset-1"><img class="img-responsive" src="images/nae.png"   alt="img"> <h3>Nae Vasilica </h3> <span class="ruolo">Community Developer</span></div>
						</div>
        </div>
    ...
    <section id="features_2">
        <div class="container">
					<caption> <h1 id="how_it_work">How it works?</h1> </caption>
							<div class="row row-centered">
	                <div class="col-sx-12 col-sm-4 col-md-4 col-lg-4 col-centered margin-top screen" ><h3>Find an apartment</h3><img class="img-responsive" src="images/2.png" alt="img"></div>
								  <div class="col-sx-12 col-sm-4 col-md-4 col-lg-4 col-centered margin-top screen2" ><h3>View apartment's infos</h3><img class="img-responsive" src="images/4.png" alt="img"></div>
									<div class="col-sx-12 col-sm-4 col-md-4 col-lg-4 col-centered margin-top screen3"><h3>View reviews of other users</h3><img class="img-responsive" src="images/5.png" alt="img"></div>
							</div>
			</div>
